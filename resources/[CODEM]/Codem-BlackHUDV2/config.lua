...
Config.WaterMarkText1 = "After-LS" -- Top right server text
Config.WaterMarkText2 = "Los Angeles"  -- Top right server text
Config.WaterMarkLogo = "https://media.discordapp.net/attachments/1107404335832367145/1201849954365083688/512.png?ex=65cb50fe&is=65b8dbfe&hm=a14723ed14e2c58b65f064cdda5d1909615060bd5a5bb92d7304a56a6e31bbc1&=&format=webp&quality=lossless" -- Logo url
...
-------------------------------------------- Money commands --------------------------------------------
Config.EnableCashAndBankCommands = false -- Determines if money commands are enabled or not
...
Config.FuelSystem = 'ox-fuel' -- LegacyFuel / ox-fuel / nd-fuel / frfuel / cdn-fuel
...
Config.Notifications = { -- Notifications
    ["stress_gained"] = {
        message = 'Vous êtes stréssé',
        type = "error",
    },
    ["stress_relive"] = {
        message =  'Vous êtes relaxé',
        type = "success",
    },
    ["took_off_seatbelt"] = {
        type = "error",
        message = "Vous avez retiré votre ceinture",
    },
    ["took_seatbelt"] = {
        type = "success",
        message = "Vous avez attaché votre ceinture",
    },
    ["cruise_actived"] = {
        type = "success",
    ...
    ["spam"] = {
        type = "error",
        message = "Veuillez patienter quelques secondes.",
    },
    ["engine_on"] = {
        type = "success",
        message = "Moteur allumé",
    },
    ["engine_off"] = {
        type = "success",
    ...
    ["cant_install_nitro"] = {
        type = "error",
        message = "Vous ne pouvez pas installer de nitro à l’intérieur du véhicule.",
    },
    ["no_veh_nearby"] = {
        type = "error",
        message = "Pas de véhicule à proximité.",
    },
    ["cash_display"] = {
        type = "success",
        message = "Vous avez $%s dans votre poche.",
    },
    ["bank_display"] = {
        type = "success",
        message = "Vous avez $%s dans votre banque.",
    },
}

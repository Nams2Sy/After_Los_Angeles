...
api.addGlobalVehicle({
    {
        ...
        label = '(ouvrir/fermer) Porte conducteur',
        ...
        onSelect = function(data)
            ...
            if IsVehicleDoorDamaged(data.entity, 0) then print('pas de porte') end
        end
    },
    {
        name = 'ox_target:passengerF',
        icon = 'fa-solid fa-car-side',
        label = '(ouvrir/fermer) Porte passager',
    ...
    },
    {
        ...
        icon = 'fa-solid fa-car-side',
        label = '(ouvrir/fermer) Porte arrière gauche',
    ...
    },
    {
        ...
        icon = 'fa-solid fa-car-side',
        label = '(ouvrir/fermer) Porte arrière droite',

function GetCore()
    ...
    if Config.Framework == "oldesx" then
        ...
        if not object then
            print(
                "codem-adminmenu:Framework is not selected in the config correctly if you're sure it's correct please check your events to get framework object")
        end
    end
    ...
    if Config.Framework == 'autodetect' then
        ...
        if not object then
            print(
                "codem-adminmenu:Auto detect couldn't detect your framework please check your event to get framework object")
        else
            print("codem-adminmenu:Framework object found : ", Framework)
        end
    end
